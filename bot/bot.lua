...
bot_token = "697376469:AAHQZJaHgENZN67uNHXqf31tRQARYvQxuME" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		BeyondTeam = '/root/ArcaneTeamBot'
	elseif not server_user:match("^root$") then
		BeyondTeam = '/home/'..server_user..'/ArcaneTeamBot'
	end
  ...
  config = {
    ...
    sudo_users = {122630959},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..BeyondTeam..'/data/moderation.json'},
    info_text = [[*》@ArcaneTeam
]],
  }
